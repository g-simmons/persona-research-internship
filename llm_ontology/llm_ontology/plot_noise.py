...
fig, ax = plt.subplots()
ax.plot(steps, model_func(steps, *params_70M))
ax.plot(steps, model_func(steps, *params_160M))
ax.plot(steps, model_func(steps, *params_14B))
ax.plot(steps, model_func(steps, *params_28B))
ax.plot(steps, model_func(steps, *params_12B))

ax.plot(steps, hierarchy_score_70M)
ax.plot(steps, hierarchy_score_160M)
ax.plot(steps, hierarchy_score_14B)
ax.plot(steps, hierarchy_score_28B)
ax.plot(steps, hierarchy_score_12B)
...
ax.plot(steps, causal_sep_score_70M)
ax.plot(steps, causal_sep_score_160M)
ax.plot(steps, causal_sep_score_14B)
ax.plot(steps, causal_sep_score_28B)
ax.plot(steps, causal_sep_score_12B)

fig.savefig(f"plots/test2.png")
plt.close(fig)
