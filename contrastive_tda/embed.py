...
def _embed_cloud(items: Iterable, embed_field: str, embed_model: str) -> List:
    co = init_cohere_api()
...
def embed(items: Iterable, embed_field: str, embed_method: str, embed_model: str) -> List:
    """
    ...
    if embed_method == "local":
        ...
        return _embed_cloud(items, embed_field, embed_model)
