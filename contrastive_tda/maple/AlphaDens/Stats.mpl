Stats := module()
option package;
export randelt,randf,randrange,randi,rowsum,colsum,rownorm,colnorm,sample,rsubset,rv,tnorm,rsphere,dker,cis,meanstd,normdata,subpca,pca,meannorm,meancent,svd,mpca,normsamp,sampgauss,covmat,rowsamp,getpca;
local sqrt2,rt2pi;
