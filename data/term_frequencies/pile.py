...
#Neither of these functions are actively used but could be good helper functions for processing multiple files
def getAllFileFrequencies(folderPath):
    for file in os.listdir(folderPath):
        addFileFrequenciesToJson(file, folderPath)

def getMultipleFileFrequencies(fileNames, folderPath):
